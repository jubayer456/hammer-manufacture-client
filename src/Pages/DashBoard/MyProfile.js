            ...
            <div className='hero-content flex-col lg:flex-row-reverse justify-between items-start'>
                ...
                <form onSubmit={updateProfile}  >
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        <input name='education' onChange='' defaultValue={users?.education} type="text" placeholder="Education" className="input input-bordered w-full max-w-xs" />
                    </div>
                    <div className="form-control w-full max-w-xs">
                        <label className="label">
                    ...
                    <div className='flex gap-8'>
                        ...
                        <div className="form-control w-36 max-w-xs">
                            ...
                            <input onChange='' name='city' defaultValue={users?.city} type="text" placeholder="City" className="input input-bordered w-full max-w-xs" />
                        </div>
                    </div>
